...
<div class="main-panel">
    <div class="container">
        <div class="page-inner">
            ...
            <form action="{{ route('article.update', $article->id) }}" method="post" novalidate>
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Article title" value="{{ old('title') ?? $article->title }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" id="status" name="status">
                                                <option value="0" {{ old('status', $article->status) == '0' ? 'selected' : '' }}>publish</option>
                                                <option value="1" {{ old('status', $article->status) == '1' ? 'selected' : '' }}>draft</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="thumbnail" class="form-control" type="text" name="thumbnail" value="{{ old('thumbnail') ?? $article->thumbnail }}" readonly>
                                              </div>
                                        </div>
                                        <div id="holder"></div>
                                    </div>
